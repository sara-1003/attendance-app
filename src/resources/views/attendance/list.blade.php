...
<div class="attendance-list">
    ...
    <div class="attendance-tabs">
        <a class="tab__pending {{ request('status') === 'pending' ? 'active' : '' }}" href="{{ route('attendance.list', ['status' => 'pending']) }}">承認待ち</a>
        <a class="tab__approved {{ request('status') === 'approved' ? 'active' : '' }}" href="{{ route('attendance.list', ['status' => 'approved']) }}">承認済み</a>
    </div>
