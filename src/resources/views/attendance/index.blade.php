...
<div class="attendance-index">
    ...
    <div class="attendance-index__month">
        ...
        <a class="month__item" href="{{ route('attendance.index', ['month' => $nextMonth]) }}">翌月
            <img class="month__item--right" src="{{ asset('images/yajirushi.png') }}" alt="翌月">
        </a>
    </div>
    <div class="attendance-table">
        <table class="attendance-table__inner">
            ...
            <tr class="attendance-table__row">
                ...
                <td class="attendance-table__item"><a href="/attendance/detail/{id}">詳細</a></td>
            </tr>
            @endforeach
        </table>
    </div>
